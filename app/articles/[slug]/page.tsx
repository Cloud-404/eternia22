...
import { Clock, Calendar, Shield, ArrowLeft, Check } from "lucide-react";
...
export default async function ArticleDetailPage({ params }: PageProps) {
  ...
  if (!article || article.isStory || article.status !== "PUBLISHED") {
    notFound();
  }
  ...
  const jsonLd = {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": `https://eternia-blogs.vercel.app/articles/${article.slug}`,
    },
  };
